          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex space-x-3 mr-6">
              <a 
                ...
                className={`${isScrolled ? 'text-gray-500' : 'text-gray-300'} hover:text-blue-400 transition-colors`}
                aria-label="Twitter"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className={`${isScrolled ? 'text-gray-500' : 'text-gray-300'} hover:text-blue-600 transition-colors`}
                aria-label="Facebook"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className={`${isScrolled ? 'text-gray-500' : 'text-gray-300'} hover:text-pink-600 transition-colors`}
