          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex space-x-3 mx-4">
              <Button
                variant="ghost"
                size="icon"
                className={`${isScrolled ? 'text-muted-foreground' : 'text-white'} hover:text-blue-400`}
                asChild
              >
                <a
              ...
              <Button
                variant="ghost"
                size="icon"
                className={`${isScrolled ? 'text-muted-foreground' : 'text-white'} hover:text-blue-600`}
                asChild
              >
                <a
              ...
              <Button
                variant="ghost"
                size="icon"
                className={`${isScrolled ? 'text-muted-foreground' : 'text-white'} hover:text-pink-600`}
                asChild
              >
                <a
